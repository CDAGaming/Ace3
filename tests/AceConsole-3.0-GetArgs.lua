...
assert(a1=="a1" and a2=="a2" and a3==1e99, dump(a1,a2,a3))
...
assert(a1=="a1" and a2==nil and a3==1e99, dump(a1,a2,a3))
...
assert(a1=="a1" and a2==1e99, dump(a1,a2))

local a1,a2 = AC:GetArgs([["a 1"]])	-- quote with space in it
assert(a1=="a 1" and a2==1e99, dump(a1,a2))
...
assert(a1=="a 1" and a2=="a 2" and a3==1e99, dump(a1,a2,a3))
...
assert(a1=="foo'bar" and a2=='foo"bar' and a3==1e99, dump(a1,a2,a3))

local a1,a2 = AC:GetArgs([[  "unfinished quote]], 1)  -- missing " at end
assert(a1=="unfinished quote" and a2==1e99, dump(a1,a2))
...
assert(a1=="simple" and a2=="|Cff112233|Hitem:0:0:0:0|hand here's a text with \"s and stuff|h|r" and a3==nil and a4==1e99, dump(a1,a2,a3,a4))

local a1,a2,a3,a4 = AC:GetArgs("simple '|Cff112233|Hitem:0:0:0:0|hand here's a text with \"s and stuff|h|r'", 3)
assert(a1=="simple" and a2=="|Cff112233|Hitem:0:0:0:0|hand here's a text with \"s and stuff|h|r" and a3==nil and a4==1e99, dump(a1,a2,a3,a4))

local a1,a2,a3,a4 = AC:GetArgs("simple \"|Cff112233|Hitem:0:0:0:0|hand here's a text with \"s and stuff|h|r\" 'bar'", 3)
assert(a1=="simple" and a2=="|Cff112233|Hitem:0:0:0:0|hand here's a text with \"s and stuff|h|r" and a3=="bar" and a4==1e99, dump(a1,a2,a3,a4))

local a1,a2,a3,a4 = AC:GetArgs("simple |H|ha 1|h|H|ha 1|h", 3)
assert(a1=="simple" and a2=="|H|ha 1|h|H|ha 1|h" and a3==nil and a4==1e99, dump(a1,a2,a3,a4))

local a1,a2,a3,a4 = AC:GetArgs("simple ||H|ha 1|h|H|ha 1|h", 3)	-- note double ||
assert(a1=="simple" and a2=="||H|ha" and a3=="1|h|H|ha 1|h" and a4==1e99, dump(a1,a2,a3,a4))
